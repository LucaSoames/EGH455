...
This example will print camera extrinsic and intrinsic parameters, along with 
other calibration values written on device (EEPROM).

See: https://docs.luxonis.com/software/depthai/examples/calibration_reader

Please run the install script to download all required dependencies. 
Please note that this script must be ran from git context, so you have to 
download the depthai-python repository first and then run the script.
